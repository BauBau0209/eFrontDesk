...
public class Searchproduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "item_id", "item_name", "quntatity", "price", "mfd", "batchno"
            }
        ) {
        ...
        jLabel8.setFont(new java.awt.Font("Vrinda", 1, 24)); // NOI18N
        jLabel8.setText("Quantity");

        jLabel9.setFont(new java.awt.Font("Vrinda", 1, 24)); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MainFiles/search.jpg"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(1318, 671));
         ...
         DefaultTableModel model = (DefaultTableModel) table.getModel();
           try {
            ...
            while(rs.next()) {
               ...
               model.addRow(new Object[] {id,name,qun,price,mfd,batchno});
            }
            rs.close();
            //stmt.close();
            //con.close();
