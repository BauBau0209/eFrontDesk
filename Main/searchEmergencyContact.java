 ...
 * @author ejbau
 */
public class searchEmergencyContact extends javax.swing.JFrame {

    /**
     * Creates new form searchEmergencyContact
     */
    public searchEmergencyContact() {
        initComponents();
        fetch();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchEmergencyContact.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new searchEmergencyContact().setVisible(true);
            }
        });
    }
