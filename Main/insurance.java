...
public class insurance extends javax.swing.JFrame {
    ...
    public insurance(String[] patientData, String[] contactData, String[] insuranceData, boolean hasGuarantor){
        this();
        ...
        try {
            if (this.insuranceData != null && insuranceData.length != 0) {
    ...
    private void SaveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveButtonActionPerformed
        ...
        if(!(iPolicyNo.getText().equals("") ||
            ...
            if(!this.hasGuarantor){
                JOptionPane.showMessageDialog(null, "The patient who doesn't have a guarantor must have an insurance.");
                return;
            } else {
