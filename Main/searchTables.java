...
public class searchTables extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        patientInformationTable.setSelectionBackground(new java.awt.Color(0, 153, 204));
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        String regex = "(?i)" + searchText; // (?i) makes the regex case insensitive
        ...
        pRowSorter.setRowFilter(RowFilter.regexFilter(regex));
        ...
        eRowSorter.setRowFilter(RowFilter.regexFilter(regex));
        ...
        iRowSorter.setRowFilter(RowFilter.regexFilter(regex));   
