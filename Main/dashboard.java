...
public class dashboard extends javax.swing.JFrame {
    ...
    public void showPieChart() {
        ...
        try {
            ...
            // SQL query to count insurance policies per patient's age group
            String sql = "SELECT CASE " +
                         "    WHEN p.PatientAge < 18 THEN 'Below 18' " +
                         "    WHEN p.PatientAge BETWEEN 18 AND 30 THEN '18-30' " +
                         "    WHEN p.PatientAge BETWEEN 31 AND 45 THEN '31-45' " +
                         "    ELSE 'Above 45' " +
                         "END AS AgeGroup, " +
        ...
        piePlot.setSectionPaint("31-45", new Color(0, 102, 153));      // Dark blue
        piePlot.setSectionPaint("Above 45", new Color(0, 51, 102));    // Navy blue
    ...
    private void initComponents() {
        ...
        lbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Main/Icons/icons8-health-insurance-45.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 10)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("TOTAL PATIENTS");

        totalPatients.setFont(new java.awt.Font("Segoe UI", 1, 20)); // NOI18N
        ...
        lbl1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Main/Icons/icons8-patient-50.png"))); // NOI18N

        totalInsurances.setFont(new java.awt.Font("Segoe UI", 1, 20)); // NOI18N
